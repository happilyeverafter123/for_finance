...
def gather_filings(ticker_symbol: str, limit: int = 1) -> Path:
    ...
    print(f"Downloading 10-Q for {ticker_symbol}...")

    try:
        #get the 10-Q of the company
        base_path = Path(os.environ.get("BASE_PATH"))
        dl.get("10-Q", ticker_symbol, limit=limit)
        time.sleep(1)
        filings_path = base_path / ticker_symbol / "10-Q"
        return filings_path
...
#main function-------------------------------------------------------------------------------------
def gather_and_extract_10Q(ticker_symbol: str, limit: int):
    base_path = Path("/home/u634567g/sec-edgar-filings")
...
if __name__ == "__main__":
    ...
    results = gather_and_extract_10Q(ticker_symbol="AAPL", limit=4)
    print(results)
